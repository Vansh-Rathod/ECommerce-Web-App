...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250621142356_AddUserOtpModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedReference.RefreshTokenModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SharedReference.UserOTPModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SharedReference.UserOTPModel", b =>
                {
                    b.HasOne("SharedReference.User", "User")
                        .WithOne("UserOTP")
                        .HasForeignKey("SharedReference.UserOTPModel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
