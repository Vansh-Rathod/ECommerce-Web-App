        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserApprovalRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "LastLogin", "PasswordHash" },
                values: new object[] { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 5, 13, 0, 0, 0, 0, DateTimeKind.Utc), "vansh@satvasolutions.com", "Vansh Admin", new DateTime(2025, 5, 13, 0, 0, 0, 0, DateTimeKind.Utc), "$2a$12$V618JunCmS6bEY5LrV9QLOCE00XmCGlCoykmM2I55hH.KRQPaErkC" });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "RoleId", "UserId", "CreatedAt" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 5, 13, 0, 0, 0, 0, DateTimeKind.Utc) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sellers_City_StoreName",
                table: "Sellers",
                columns: new[] { "City", "StoreName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserApprovalRequests_UserId",
