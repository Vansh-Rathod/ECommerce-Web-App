...
namespace DataAccessLayer.Interfaces
{
    public interface IUserRepository
    {
        ...
        Task<CommonResponse<PagedResult<User>>> GetUnapprovedUsersAsync( int pageNumber, int pageSize, string searchText, string sortField, string sortOrder, DateTime? fromDate, DateTime? toDate );
        ...
        Task<CommonResponse<User>> MakeUserInactiveAsync( Guid userId );

        Task<CommonResponse<User>> MakeUserActiveAsync( Guid userId );
