...
-- Last modified: 2025-06-07 06:53 PM
-- Purpose:		Get all sellers with their profiles
-- =============================================
...
--@SortField VARCHAR(MAX) = 'fullname',
--@SortOrder VARCHAR(MAX) = 'asc',
--@FilterByStatus VARCHAR(MAX) = 'all',
--@FilterByApproval VARCHAR(MAX) = 'all'
--AS
DECLARE
@PageNumber INT = 1,
@PageSize INT = 10,
...
WHERE sp.IsActive = 1 OR sp.IsActive = 0
