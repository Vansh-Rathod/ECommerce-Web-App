...
-- Last modified: 2025-06-07 06:33 PM
-- Purpose:		Get all approved users with their roles
-- =============================================

CREATE PROCEDURE GetAllApprovedUsers
AS
BEGIN
...
WHERE sp.IsApproved = 1 OR sp.IsApproved IS NULL
